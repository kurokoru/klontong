          ...
          <div className="flex-1 mx-8">
            <div className="flex max-w-2xl">
              <input
                ...
                className="flex-1 px-4 py-3 border border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-orange-500"
              />
              ...
              <button className="bg-orange-500 text-white px-6 py-3 rounded-r-md hover:bg-orange-600 font-medium">
                Search
              </button>
            </div>
          </div>
